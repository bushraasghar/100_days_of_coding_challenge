...
let peoples : string[] = ['vincenzo','beak','haein','goblin','lee min ho'];
...
console.log("\n\tquestiom 20\n\t");
let languages: string[] = ['urdu','english','hindi','korean','thai','chinese','arabic'];
...
console.log("\n\tquest 21\t\n");
let book : {title: string , published: number, author:string} = {
    title:"Harry potter",
    published:2000,
    author: "J.K Rowling",
}
