...
console.log("\n\tQ32\n\t");
let current_user = ['admin', 'user1', 'user2', 'user4', 'user5'];
let new_user = ['User6', 'User7', 'User8', 'admin'];
...
console.log("\n\tQ33\n\t");
let ordinal_numbers = [1, 2, 3, 4, 5, 6, 7, 8];
...
console.log("\n\tQ34\n\t");
let pizzas = ['fajita', 'tikka', 'barbq', 'cheese'];
pizzas.forEach(pizzas => {
    console.log(`I like ${pizzas} pizza flavour`);
});
// *Question 35:* Animals: Highlight animals with a common trait.
let pet_animals = ['cat', 'dog', 'goat', 'rabbit'];
...
console.log("\n\tQ37\n\t");
function make_shirt(size = 'large', message = 'I love tsc') {
